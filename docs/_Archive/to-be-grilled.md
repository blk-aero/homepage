...
This file serves as the **single source of truth for all outstanding design decisions**, removing the need to consult the files in `/_Archive` for future backlog work.
...
*   **Source**: `docs/_Archive/draft_prd.md` (Milestone 1, Step 1D)
...
*   **Source**: `docs/_Archive/initial_prd.md` (Milestone 4, Step 1D)
...
*   **Source**: `docs/_Archive/draft_prd.md` (Step 2, `competitor_comparison`)
...
*   **Source**: `docs/_Archive/RESEARCH.md` (AutoSite competitor benchmark) and `docs/Archive/DESIGN.md`
...
*   **Source**: `docs/_Archive/initial_prd.md` (PRD Targets / KPIs)
...
*   **Source**: `docs/_Archive/initial_prd.md` (AEO Schema rules)
...
*   **Source**: `docs/_Archive/initial_prd.md` (AEO requirements)
...
*   **Source**: `docs/_Archive/remaining_prd_work.md` (IndexNow verification)
...
*   **Source**: `docs/_Archive/remaining_prd_work.md` (strict warnings against thin pages)
...
*   **Source**: `docs/_Archive/initial_prd.md` (RAG formatting constraints)
...
*   **Source**: `docs/_Archive/initial_prd.md` (Trustworthiness constraint)
...
*   **Source**: `docs/_Archive/draft_prd.md` (Freshness signals)
...
*   **Source**: `docs/_Archive/initial_prd.md` (Attribution persistence)
...
*   **Source**: `docs/_Archive/draft_prd.md` (SEO Quality Gate)
